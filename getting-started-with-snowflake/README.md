...
| 8 | データ共有（隣の参加者と相互共有）・Marketplace | [scripts/07_data_sharing.sql](scripts/07_data_sharing.sql) | [steps/08_sharing_and_cleanup.md](steps/08_sharing_and_cleanup.md) |
...
│   ├── 06_roles.sql               # ロール管理
│   └── 07_data_sharing.sql        # データ共有（隣の参加者と相互共有）
