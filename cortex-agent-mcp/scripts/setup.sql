...
-- マートテーブルへの SELECT（Cortex Analyst が読むのに必要）
GRANT SELECT ON ALL TABLES        IN SCHEMA HANDSON_CORTEX_AGENT.BRAZE TO ROLE R_HANDSON;
GRANT SELECT ON FUTURE TABLES     IN SCHEMA HANDSON_CORTEX_AGENT.BRAZE TO ROLE R_HANDSON;
