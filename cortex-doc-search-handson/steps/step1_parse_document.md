...
PMDAの「ご利用にあたっての注意事項」（<https://www.pmda.go.jp/searchhelp_005.html>）に、
次の記載があります。

- **電子添文の著作権は製造販売業者が保有**する
- **自らが所属する医療機関・薬局等での使用を目的とする場合を除き、
  製造販売業者に無断での複製・転載・頒布等は禁止**。
  研究等に利用する場合は製造販売業者に許諾を取ることが求められている
- **自動的に添付文書等を巡回ダウンロードするアプリケーションは認められていない**
- 改訂されると最新版に差し替えられるため、**URLは将来無効になる**

したがって:

- ハンズオン中に講師のステージにあるファイルは、**その場での説明用**です
- 自分の環境で試す場合は、**自分でダウンロードしてください**
- 業務で継続的に多数の文書を取り込む用途では、一括取得の禁止事項に触れます。
  設計を変えるか、権利者に確認してください
