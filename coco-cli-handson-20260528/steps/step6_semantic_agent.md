...
```
SNOW_RETAIL_DB.SNOW_RETAIL_SCHEMA の RETAIL_DATA と EC_DATA、PRODUCT_MASTER を
...
> 参考: `steps/6-1_snowretail_sv.yaml` (GitHub)
...
```
SNOW_RETAIL_DB.SNOW_RETAIL_SCHEMA.SNOW_RETAIL_DOCUMENTS テーブルの
